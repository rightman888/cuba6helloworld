...
public class CubasixTestContainer extends TestContainer {

    public CubasixTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubasix/app.properties",
    ...
    public static class Common extends CubasixTestContainer {

        public static final CubasixTestContainer.Common INSTANCE = new CubasixTestContainer.Common();
